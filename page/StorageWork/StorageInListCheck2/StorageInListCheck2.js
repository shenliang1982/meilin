  ...
  go_last() {
    ...
    dd.httpRequest({
      ...
      data: {
        ...
        name_space: "StorageWork.StorageInListCheck.CheckNo"
      },
      dataType: 'json',
      success: (res2) => {
        if (res2.data.is_ok) {
  ...
  go_next() {
    ...
    dd.httpRequest({
      ...
      data: {
        ...
        code_login: t.data.login.code_login,
        no_bill: t.data.no_bill,
        name_space: "StorageWork.StorageInListCheck.CheckYes"
      },
      dataType: 'json',
      success: (res2) => {
        if (res2.data.is_ok) {
      ...
      success: function (res) {
        ...
        dd.httpRequest({
          ...
          data: {
            ...
            code_login: t.data.login.code_login,
            no_bill: t.data.no_bill,
            name_space: "StorageWork.StorageInListCheck.BindinggridControl2"
          },
          dataType: 'json',
          success: (res2) => {
